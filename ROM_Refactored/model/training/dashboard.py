...
class TrainingDashboard:
    ...
    def _create_model_arch_tab(self):
        ...
        # Transition type
        transition_options = ['linear', 'clru', 's4d', 's4d_dplr', 's5', 'koopman', 'ct_koopman']
    ...
    def _run_training(self):
        ...
        with self.training_output:
            ...
            output_dir = os.path.join(_ROM_DIR, 'saved_models') + os.sep
            ...
            with Timer("training", log_dir=os.path.join(_ROM_DIR, 'timing_logs')) as timer:
